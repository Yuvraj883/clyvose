    ...
    >
      ...
      <div className="max-w-lg w-full text-center px-8 py-10 bg-slate-900/35 border border-white/[0.06] rounded-3xl shadow-2xl backdrop-blur-xl relative z-10 mx-4">
        ...
        <a
          ...
          className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-indigo-600 hover:to-blue-600 text-white font-bold px-8 py-3.5 rounded-2xl shadow-[0_4px_16px_rgba(99,102,241,0.25)] hover:shadow-[0_4px_24px_rgba(99,102,241,0.45)] hover:scale-[1.03] active:scale-95 transition-all duration-300 text-sm sm:text-base animate-pop"
        >
          Book a Free Discovery Call →
        </a>
        <p className="text-xs mt-5 text-indigo-400 italic font-semibold tracking-wide animate-pulse-slow">
